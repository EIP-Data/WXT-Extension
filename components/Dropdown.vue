...
const selectOption = (option: { label: string; value: string }, event: MouseEvent) => {
  event.stopPropagation()
...
<template>
  <div ref="dropdownRef" class="relative w-full">
    ...
    <!-- Use Teleport to render outside parent stacking context -->
    <Teleport to="body">
      <transition
      ...
      >
        <ul
            ...
            class="fixed mt-1 w-full max-w-xs max-h-60 overflow-auto rounded-md
